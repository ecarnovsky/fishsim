...
const GUPPY_GENE_LIST = [
    ...
    new Gene("longfin suppressor", "autosomal", [
        // suppresses longfin
    ...
    new Gene("black pigment", "autosomal", [
    ...
    new Gene("red pigment", "autosomal", [
        // allows red pigment
    ...
    new Gene("yellow pigment", "autosomal", [
    ...
    new Gene("blue pigment", "autosomal", [
        // allows blue pigment
